...
public class ShtepiaBotuese implements Parcelable {
    ...
    public final static Parcelable.Creator<ShtepiaBotuese> CREATOR = new Creator<ShtepiaBotuese>() {


        @SuppressWarnings({
                "unchecked"
        })
        public ShtepiaBotuese createFromParcel(Parcel in) {
            return new ShtepiaBotuese(in);
        }

        public ShtepiaBotuese[] newArray(int size) {
            return (new ShtepiaBotuese[size]);
        }

    };

    protected ShtepiaBotuese(Parcel in) {
